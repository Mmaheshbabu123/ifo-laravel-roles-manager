...
use App\Models\PermissionClassifications as Permission;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Http\Requests\StorePermissionTypesRequest as StorePermissionRequest;
use App\Http\Requests\UpdatePermissionTypesRequest as UpdatePermissionRequest;
use Illuminate\Support\Facades\Gate;
use Illuminate\Http\Response;
use App\Models\PermissionClassifications;
use App\Http\Requests\UpdatePermissionTypesRequest;
class PermissionClassificationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.permission_classfications.index',compact('permissions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.permission_classfications.create');
    }
    ...
    public function edit( PermissionClassifications $permission_classfication)
    {
      ...
      //  abort_if(Gate::denies('permission_edit'), Response::HTTP_FORBIDDEN, 'Forbidden');
        ...
        return view('admin.permission_classfications.edit', compact('permission_classfication'));
    }

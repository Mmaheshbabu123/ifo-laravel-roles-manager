...
use App\Models\PermissionClassifications as permissionTypes;
class PermissionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.permissions.create', compact('permissionTypes'));
    ...
    public function edit(Permission $permission)
    {
        ...
        return view('admin.permissions.edit', compact('permission','permissionTypes'));
